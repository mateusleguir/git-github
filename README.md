...
Para mostrar um comando de alguma linguagem em destaque, se utliza crase no inicio e no fim do comando(`O comando que será destacado vai ficar entre crases`).<br>
